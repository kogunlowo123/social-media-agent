"""Social Media Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Social media management agent that creates platform-specific posts, schedules publishing, analyzes engagement metrics, monitors brand mentions, and manages community interactions.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
